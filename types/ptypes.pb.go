...
func (x *AggDistanceReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AggDistanceReq) ProtoMessage() {}

func (x *AggDistanceReq) ProtoReflect() protoreflect.Message {
	mi := &file_types_ptypes_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AggDistanceReq.ProtoReflect.Descriptor instead.
func (*AggDistanceReq) Descriptor() ([]byte, []int) {
	return file_types_ptypes_proto_rawDescGZIP(), []int{1}
}

func (x *AggDistanceReq) GetObuId() int32 {
	if x != nil {
		return x.ObuId
	}
	return 0
...
func (x *AggDistanceReq) GetValue() float64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *AggDistanceReq) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_types_ptypes_proto_rawDesc = []byte{
	...
	,
...
var file_types_ptypes_proto_goTypes = []interface{}{
	(*None)(nil),           // 0: None
	(*AggDistanceReq)(nil), // 1: AggDistanceReq
	(*GetInvoiceReq)(nil),  // 2: GetInvoiceReq
}
var file_types_ptypes_proto_depIdxs = []int32{
	1, // 0: DistanceAggregator.AggregateDistance:input_type -> AggDistanceReq
