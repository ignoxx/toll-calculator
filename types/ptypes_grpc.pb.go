...
type DistanceAggregatorClient interface {
	AggregateDistance(ctx context.Context, in *AggDistanceReq, opts ...grpc.CallOption) (*None, error)
}
...
func (c *distanceAggregatorClient) AggregateDistance(ctx context.Context, in *AggDistanceReq, opts ...grpc.CallOption) (*None, error) {
...
type DistanceAggregatorServer interface {
	AggregateDistance(context.Context, *AggDistanceReq) (*None, error)
...
func (UnimplementedDistanceAggregatorServer) AggregateDistance(context.Context, *AggDistanceReq) (*None, error) {
	return nil, status.Error(codes.Unimplemented, "method AggregateDistance not implemented")
}
...
func RegisterDistanceAggregatorServer(s grpc.ServiceRegistrar, srv DistanceAggregatorServer) {
	// If the following call panics, it indicates UnimplementedDistanceAggregatorServer was
...
func _DistanceAggregator_AggregateDistance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistanceAggregatorServer).AggregateDistance(ctx, req.(*AggDistanceReq))
	}
